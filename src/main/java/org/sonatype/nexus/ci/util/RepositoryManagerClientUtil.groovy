...
{
  /**
   * @deprecated use version specific calls {@link RepositoryManagerClientUtil#nexus2Client}
   */
  @Deprecated
   ...
   * @return a {@link RepositoryManagerV3Client}
   */
  static RepositoryManagerV3Client nexus3Client(String url, String credentialsId, boolean anonymousAccess)
      throws URISyntaxException
  {
    def uri = new URI(url)
    ...
    return clientBuilder.withAnonymousAccess(anonymousAccess).build()
  }
